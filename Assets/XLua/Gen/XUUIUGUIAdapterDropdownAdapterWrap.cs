...
namespace XLua.CSObjectWrap
{
    ...
    public class XUUIUGUIAdapterDropdownAdapterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XUUI.UGUIAdapter.DropdownAdapter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XUUI.UGUIAdapter.DropdownAdapter gen_ret = new XUUI.UGUIAdapter.DropdownAdapter();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XUUI.UGUIAdapter.DropdownAdapter constructor!");
        ...
        static int _g_get_OnValueChange(RealStatePtr L)
        {
		    try {
                ...
                XUUI.UGUIAdapter.DropdownAdapter gen_to_be_invoked = (XUUI.UGUIAdapter.DropdownAdapter)translator.FastGetCSObj(L, 1);
